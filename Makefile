...
SOURCES = lexer.mll utils.ml parser.mly config.ml relationmatrix.ml callgraph.ml cycle.ml debug.ml fsafe.ml pprinter.ml wftype.ml typechecker.ml termination.ml interpret.ml handler.ml main.ml
EXEC = fsafe
