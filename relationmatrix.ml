...
(* empty : int -> int -> relationmatrix *)
let empty c l = 
  { data = Array.create_matrix c l Unknown ; nb_c = c ; nb_l = l }

(* add : relation -> relation -> relation *)
let add relations =
...
(* mult : relation -> relation -> relation *)
let mult relations =
  match relations with
...
(* multiplication of two matrices of relations *)
(* multiplication : relationmatrix -> relationmatrix -> relationmatrix *)
...
(* string_of_relation : relation -> string *)
...
(* string_of_relationmatrix : relationmatrix -> string *)
